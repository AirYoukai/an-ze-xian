...
import com.anzexian.demo.util.wxPaySDKTencent.WXPayConfig;
import com.anzexian.demo.util.wxPaySDKTencent.WXPayConstants;
...
public class WXPayReport {
    ...
    public static class ReportInfo {
        ...
        private String sdk = com.anzexian.demo.util.wxPaySDKTencent.WXPayConstants.WXPAYSDK_VERSION;
    ...
    private com.anzexian.demo.util.wxPaySDKTencent.WXPayConfig config;
    private ExecutorService executorService;

    private volatile static WXPayReport INSTANCE;

    private WXPayReport(final com.anzexian.demo.util.wxPaySDKTencent.WXPayConfig config) {
        this.config = config;
